...
func (q *Queries) CreateModel(ctx context.Context, arg CreateModelParams) (Model, error) {
	row := q.queryRow(ctx, q.createModelStmt, createModel,
		arg.Name,
		arg.Title,
		arg.Fax,
		arg.Web,
...
func (q *Queries) GetModel(ctx context.Context, id int32) (Model, error) {
	row := q.queryRow(ctx, q.getModelStmt, getModel, id)
	var i Model
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) ListModels(ctx context.Context, arg ListModelsParams) ([]Model, error) {
	rows, err := q.query(ctx, q.listModelsStmt, listModels, arg.ID, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateModel(ctx context.Context, arg UpdateModelParams) error {
	_, err := q.exec(ctx, q.updateModelStmt, updateModel,
		arg.Name,
		arg.Title,
		arg.Fax,
		arg.Web,
